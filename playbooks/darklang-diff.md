...
11. DO NOT COMMIT OR MERGE UNTIL I SAY "approved". After that, commit the code and updated tests. Include in the commit message a description of the difference that was fixed. Rebase off the main branch (NOT origin/main). Do a fast-forward merge onto the main branch after running tests again.
